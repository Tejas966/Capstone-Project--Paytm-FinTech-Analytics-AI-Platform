...
# NOTE: Run this script from inside the credit_risk_lending_ml/ folder:
#   cd credit_risk_lending_ml && python generate_data.py
# The CSVs are written via relative paths and will land in the same folder.
...
print(f"  - Thin-file (missing bureau score): {df['credit_bureau_score'].isna().sum()} rows")
